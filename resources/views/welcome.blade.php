...
<head>
  ...
  <link href="{{ asset('frontend/asset/css') }}/css/blog-home.css" rel="stylesheet">
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        @auth('frontend')
            <a href=" {{ route('frontend.dashboard') }} ">Frontend Dashboard</a>
        @else
            <a href=" {{ route('frontend.login') }} ">Frontend Login</a>
        @endauth

        <!-- Blog Post -->
        {{-- @foreach ($posts as $post) --}}
        <div class="card mb-4">
          {{-- <img class="card-img-top" src="{{ asset('/storage/posts_image/'.$post->image )}}"" alt="Card image cap"> --}}
          {{-- testing --}}
          {{-- <img class="card-img-top" src="{{ $post->image }}"" alt="Card image cap" height="400"> --}}
          {{-- testing --}}
          <div class="card-body">
  ...
  <script src="{{ asset('frontedn/asset') }}/vendor/jquery/jquery.min.js"></script>
